...
const Inicio = () => {
    return ( 
        <section id="inicio" className='flex mx-auto  max-w-7xl px-10 sm:px-20  altoinicio items-center h-[90vh] '>
        <div className=' w-full '>
          <div className={`w-full mx-auto md:mx-0 md:w-1/2 `}>
            <h2 className={`font-black text-4xl xl:text-5xl font-poppins`}><span className='text-blue_primary'>Educación</span> <br /> y servicios de <br /> <span className='text-blue_primary'>informática</span> , en idexa <br /> desarrollamos tus ideas</h2>
            <p className='text-lg text-gray-500  font-normal'>Brindamos soluciones innovadoras y eficientes para satisfacer las necesidades de nuestros clientes.Ofrecemos una amplia gama de servicios y cursos de tecnología para ayudarlo a mantenerse a la vanguardia en la era digital actual.</p>
          </div>
